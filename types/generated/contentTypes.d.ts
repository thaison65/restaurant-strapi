...
export interface ApiBookingDetailBookingDetail
  extends Struct.CollectionTypeSchema {
...
export interface ApiTableTable extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    desk_img: Schema.Attribute.Media<'images' | 'files' | 'videos' | 'audios'>;
    name: Schema.Attribute.String;
    description: Schema.Attribute.Text;
    create_at: Schema.Attribute.DateTime;
    update_at: Schema.Attribute.DateTime;
